...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.childrenProps = undefined;
	exports.createPropAssignmentMap = createPropAssignmentMap;
	...
	var _lodash3 = __webpack_require__(161);

	var _lodash4 = _interopRequireDefault(_lodash3);

	var _lodash5 = __webpack_require__(163);

	var _lodash6 = _interopRequireDefault(_lodash5);

	var _lodash7 = __webpack_require__(164);

	var _lodash8 = _interopRequireDefault(_lodash7);

	var _lodash9 = __webpack_require__(173);

	var _lodash10 = _interopRequireDefault(_lodash9);

	var _lodash11 = __webpack_require__(195);
	...
	var isExtensibleProp = function isExtensibleProp(key) {
	  return ['style'].indexOf(key) > -1;
	};
	...
	var childrenProps = exports.childrenProps = function childrenProps(name, props) {
	  ...
	  return keys.reduce(function (childProps, key) {
	    if (key.match(new RegExp('^' + name + '[A-Z]', 'i'))) {
	      ...
	      if ((0, _lodash4.default)(newKey)) {
	        return childProps;
	      }
	      var lowerFirst = newKey[0].toLowerCase() + newKey.slice(1);
	...
	*/
	function mergeProps(defaultProps, passedProps) {
	  var keys = Object.keys(defaultProps).concat(Object.keys(passedProps));

	  return keys.reduce(function (merged, key) {
	    if (merged.hasOwnProperty(key)) {
	      return merged;
	    } else if (isExtensibleProp(key)) {
	      merged[key] = (0, _lodash2.default)({}, defaultProps[key], passedProps[key]);
	...
	var shouldNotRender = function shouldNotRender(props, childProps, originalChildProps, name) {
	  if (childProps.render === false) {
	    return true;
	  }

	  if (isFunction(childProps.render) && !childProps.render(originalChildProps)) {
	    return true;
	  }

	  if (props.strictRender === true || (0, _lodash10.default)(props.strictRender, name)) {
	    if (!props[name] && ((0, _lodash4.default)(childProps) || props[name] === false)) {
	      return true;
	    }
	  }
	};

	function createPropAssignmentMap(props, arrayOfNames) {
	  var propKeys = (0, _lodash12.default)(Object.keys(props), ['children', 'ref']);

	  var assigner = arrayOfNames.reduce(function (propLookup, name) {
	    if ((0, _lodash10.default)(propKeys, name + 'Props')) {
	      propKeys = (0, _lodash12.default)(propKeys, name + 'Props');
	      propLookup[name] = props[name + 'Props'];
	      return propLookup;
	    }

	    var nameProps = propKeys.reduce(function (childProps, key) {
	      if (key.match(new RegExp('^' + name + '[A-Z]', 'i'))) {
	        var newKey = key.replace(name, '');
	        if ((0, _lodash4.default)(newKey)) {
	          return childProps;
	        ...
	        var lowerFirst = newKey[0].toLowerCase() + newKey.slice(1);
	        childProps[lowerFirst] = props[key];
	        propKeys = (0, _lodash12.default)(propKeys, key);
	      }
	      return childProps;
	    }, {});

	    if (!(0, _lodash4.default)(nameProps)) {
	  ...
	  assigner.$main = propKeys.reduce(function (rootProps, key) {
	...
	function getNames(children) {
	  ...
	  var arr = _react2.default.Children.toArray(children).reduce(function (refs, child) {
	    if (!child || (0, _lodash6.default)(child)) {
	      return refs;
	    }

	    var displayName = (0, _lodash6.default)(child.type) ? child.type : child.type.displayName;
	    var name = displayName && displayName[0].toLowerCase() + displayName.slice(1);
	    var ref = (0, _lodash6.default)(child.props.ref) ? child.props.ref : child.props.exRef;

	    var childrenNames = getNames(child.props.children);
	...
	*/
	function customRender(Element, params) {
	  ...
	  var passProps = (0, _lodash8.default)(mergedProps, 'component');
	...
	function extendChildren(props, children, propAssigner) {
	  if (!children) {
	    return null;
	  }
	  ...
	  return _react2.default.Children.map(children, function (child) {
	    ...
	    var childProps = (0, _lodash2.default)({}, propAssigner[name], propAssigner[ref]);

	    if (shouldNotRender(props, childProps, child.props, name) || shouldNotRender(props, childProps, child.props, ref)) {
	      return null;
	    }
	...
	var PropExtender = function (_React$Component) {
	  _inherits(PropExtender, _React$Component);

	  function PropExtender() {
	    _classCallCheck(this, PropExtender);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(PropExtender).apply(this, arguments));
	  }

	  _createClass(PropExtender, [{
	    key: 'render',
	    value: function render() {
	      var namesArray = getNames(this.props.children);
	      var propAssigner = createPropAssignmentMap(this.props, namesArray);

	      return _react2.default.createElement(
	        'span',
	        null,
	        extendChildren(this.props, this.props.children, propAssigner)
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseIndexOf = __webpack_require__(174),
	    forOwn = __webpack_require__(175),
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Available under MIT license <http://lodash.com/license>
	 */
	var baseBind = __webpack_require__(179),
